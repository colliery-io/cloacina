...
**State at break:** host side fully migrated + compiles green under both constructor features (contract, macro+shell, loader, packaging). Fixtures + wasm tests NOT yet migrated (they're target/feature-gated; default build unaffected). T-0834 done+verified+green (uncommitted on main). T-0832 plumbing (P1/P2) in+green (uncommitted). Decisions all captured: A-0010, A-0011 (both decided), S-0015. Tasks: T-0837 (this, active) → T-0836 → T-0832 (held) ; T-0835 deferred. **Nothing committed/PR'd yet — a large uncommitted pile on main.**
