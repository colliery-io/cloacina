---
id: ci-integration-and-baseline
level: task
...
updated_at: 2026-04-07T12:02:59.595482+00:00
...
# CI integration and baseline documentation for computation graph benchmarks
...
- [ ] `angreal performance computation-graph` runs the soak test (T-0404)
- [ ] `angreal performance computation-graph-bench` runs the latency/throughput benchmark (T-0405)
- [ ] Both tasks integrated into `angreal performance all` if it exists
- [ ] Baseline numbers documented: latency p50/p95/p99, max throughput, memory delta
- [ ] Numbers recorded from a reference machine (dev laptop or CI runner)
- [ ] Doc page at `docs/content/explanation/computation-graphs/performance.md` or similar
