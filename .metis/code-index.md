...
> Generated: 2026-04-04T20:10:27Z | 388 files | JavaScript, Python, Rust
...
- pub `computation_graph_attr` function L32-40 — `(args: TokenStream, input: TokenStream) -> TokenStream` — The `#[computation_graph]` attribute macro entry point.
-  `graph_ir` module L22 — `-` — `#[computation_graph]` attribute macro implementation.
-  `parser` module L23 — `-` — validates it, and generates a compiled async function.
-  `computation_graph_impl` function L42-57 — `( args: proc_macro2::TokenStream, input: proc_macro2::TokenStream, ) -> syn::Res...` — validates it, and generates a compiled async function.
