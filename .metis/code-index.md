...
> Generated: 2026-04-19T16:05:16Z | 478 files | JavaScript, Python, Rust
...
-  `test_runner_execute_registered_workflow` function L1526-1573 — `()`
-  `NoOpTask` struct L1533 — `-`
-  `NoOpTask` type L1536-1549 — `= NoOpTask`
-  `execute` function L1537-1542 — `( &self, context: cloacina::Context<serde_json::Value>, ) -> Result<cloacina::Co...`
-  `id` function L1543-1545 — `(&self) -> &str`
-  `dependencies` function L1546-1548 — `(&self) -> &[cloacina::TaskNamespace]`
-  `test_runner_get_cron_execution_stats_invalid_date` function L1577-1586 — `()`
-  `test_runner_list_cron_schedules_enabled_only` function L1590-1619 — `()`
-  `test_with_schema_rejects_sqlite` function L1625-1629 — `()`
-  `test_with_schema_rejects_empty_schema` function L1633-1640 — `()`
-  `test_with_schema_rejects_invalid_chars` function L1644-1651 — `()`
-  `test_shutdown_error_display` function L1655-1664 — `()`
...
- pub `package_loader` module L76 — `-` — `#[pymodule]` definition.
-  `computation_graph_tests` module L31 — `-` — `#[pymodule]` definition.
-  `runtime_impl` module L81 — `-` — `#[pymodule]` definition.
-  `cloaca` function L90-141 — `(m: &Bound<'_, PyModule>) -> PyResult<()>` — `#[pymodule]` definition.
-  `tests` module L144-362 — `-` — `#[pymodule]` definition.
-  `test_python_workflow_via_with_gil` function L150-197 — `()` — `#[pymodule]` definition.
...
- pub `import_and_register_python_workflow_named` function L227-379 — `( workflow_dir: &Path, vendor_dir: &Path, entry_module: &str, package_name: &str...` — cloacina task execution engine.
- pub `import_python_computation_graph` function L387-464 — `( workflow_dir: &Path, vendor_dir: &Path, entry_module: &str, graph_name: &str, ...` — Import a Python computation graph module and return the graph name.
...
-  `py_var` function L469-471 — `(name: &str) -> PyResult<String>` — Python binding: `cloaca.var(name)` — resolve a `CLOACINA_VAR_{NAME}` env var.
-  `py_var_or` function L476-478 — `(name: &str, default: &str) -> String` — Python binding: `cloaca.var_or(name, default)` — resolve with a fallback.
...
- pub `CloacinaPythonRuntime` struct L33 — `-` — Zero-state runtime — every method thin-wraps the crate-local helpers.
- pub `install` function L101-103 — `()` — Install [`CloacinaPythonRuntime`] as this process's Python runtime.
-  `CloacinaPythonRuntime` type L35-96 — `impl PythonRuntime for CloacinaPythonRuntime` — are loaded through fidius.
-  `load_workflow_package` function L36-64 — `( &self, archive_data: &[u8], staging_dir: &Path, tenant_id: &str, ) -> Result<L...` — are loaded through fidius.
-  `load_cg_package` function L66-95 — `( &self, archive_data: &[u8], staging_dir: &Path, tenant_id: &str, graph_name: &...` — are loaded through fidius.
...
- pub `__call__` function L355-425 — `(&self, py: Python, func: PyObject) -> PyResult<PyObject>`
- pub `task` function L503-531 — `( id: Option<String>, dependencies: Option<Vec<PyObject>>, retry_attempts: Optio...`
...
-  `TaskDecorator` type L354-426 — `= TaskDecorator`
-  `TaskDecorator` type L428-485 — `= TaskDecorator`
-  `convert_dependencies_to_namespaces` function L430-484 — `( &self, py: Python, context: &PyWorkflowContext, ) -> PyResult<Vec<cloacina::Ta...` — Convert mixed dependencies (strings and function objects) to TaskNamespace objects
...
- pub `PyWorkflow` struct L228-230 — `{ inner: cloacina::Workflow }` — Python wrapper for Workflow
...
- pub `register_workflow_constructor` function L396-414 — `(name: String, constructor: PyObject) -> PyResult<()>` — Register a workflow constructor function
-  `PyWorkflowBuilder` type L30-223 — `= PyWorkflowBuilder`
-  `PyWorkflow` type L233-310 — `= PyWorkflow`
-  `tests` module L313-392 — `-`
...
-  `test_workflow_builder_build_with_task` function L357-391 — `()`
