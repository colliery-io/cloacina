...
///
/// Must match `cloacina_ctl_task_metadata` generated by the `#[workflow]` macro.
#[repr(C)]
#[derive(Debug, Clone)]
pub struct TaskMetadata {
    ...
    /// Template for namespaced ID (e.g., "{tenant}::{pkg}::workflow_name::task_id")
...
///
/// Must match `cloacina_ctl_package_tasks` generated by the `#[workflow]` macro.
#[repr(C)]
#[derive(Debug, Clone)]
pub struct TaskMetadataCollection {
    ...
    /// Workflow fingerprint for integrity verification
    pub workflow_fingerprint: *const std::os::raw::c_char,
    /// JSON-encoded graph data
