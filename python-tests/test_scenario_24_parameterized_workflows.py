...
class TestParameterizedWorkflows:
    ...
    def test_parameterized_workflow_construction(self, shared_runner):
        ...
        task_double = create_parameterized_task("param_task_double", 2)  # noqa: F841
        task_triple = create_parameterized_task("param_task_triple", 3)  # noqa: F841
        task_quadruple = create_parameterized_task("param_task_quadruple", 4)  # noqa: F841
        ...
        workflow = create_parameterized_workflow("parameterized_test_workflow", task_configs)  # noqa: F841
