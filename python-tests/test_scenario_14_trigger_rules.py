...
class TestTriggerRules:
    ...
    def test_comprehensive_trigger_rule_patterns(self, shared_runner):
        ...
        def create_all_success_workflow():
            builder = cloaca.WorkflowBuilder("all_success_workflow")
            builder.description("All success trigger rule test")
            builder.add_task("success_dep_1")
            builder.add_task("success_dep_2")
            builder.add_task("all_success_task")
            return builder.build()
        
        cloaca.register_workflow_constructor("all_success_workflow", create_all_success_workflow)
        ...
        def create_one_success_workflow():
            builder = cloaca.WorkflowBuilder("one_success_workflow")
            builder.description("One success trigger rule simulation")
            builder.add_task("condition_source_1")
            builder.add_task("condition_source_2")
            builder.add_task("one_success_simulation")
            return builder.build()
        
        cloaca.register_workflow_constructor("one_success_workflow", create_one_success_workflow)
        ...
        def create_none_failed_workflow():
            builder = cloaca.WorkflowBuilder("none_failed_workflow")
            builder.description("None failed trigger rule simulation")
            builder.add_task("none_failed_dep_1")
            builder.add_task("none_failed_dep_2")
            builder.add_task("none_failed_simulation")
            return builder.build()
        
        cloaca.register_workflow_constructor("none_failed_workflow", create_none_failed_workflow)
        ...
        def create_complex_trigger_workflow():
            builder = cloaca.WorkflowBuilder("complex_trigger_workflow")
            builder.description("Complex trigger condition patterns")
            builder.add_task("complex_source_a")
            builder.add_task("complex_source_b")
            builder.add_task("complex_source_c")
            builder.add_task("complex_trigger_logic")
            return builder.build()
        
        cloaca.register_workflow_constructor("complex_trigger_workflow", create_complex_trigger_workflow)
        ...
        def create_validation_workflow():
            builder = cloaca.WorkflowBuilder("validation_trigger_workflow")
            builder.description("Trigger rule dependency validation")
            builder.add_task("validation_dep_1")
            builder.add_task("validation_dep_2")
            builder.add_task("validation_trigger")
            return builder.build()
        
        cloaca.register_workflow_constructor("validation_trigger_workflow", create_validation_workflow)
