    ...
    def generate_error_report(context):
        ...
        error_report = {
            "report_metadata": {
                ...
                "workflow_execution": context.get("tutorial", "04")
            },
            "success_metrics": {
...
if __name__ == "__main__":
    print("=== Cloacina Python Tutorial 04: Error Handling and Recovery ===")
    print()
    ...
    print()
    print("Next steps:")
    print("- Try python_tutorial_05_cron_scheduling.py for scheduled workflows")
