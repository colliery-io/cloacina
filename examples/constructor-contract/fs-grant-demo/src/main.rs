...
//!
//! ONE provider crate (`providers/cloacina-provider-fs`) is a *suite* (`cloacina-provider-fs`)
...
/// Package `providers/cloacina-provider-fs` into an (unsigned) provider archive and unpack it
