...
T = TypeVar("T", bound="FireReactorRequestInputs")


@_attrs_define
class FireReactorRequestInputs:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        fire_reactor_request_inputs = cls()

        fire_reactor_request_inputs.additional_properties = d
        return fire_reactor_request_inputs
