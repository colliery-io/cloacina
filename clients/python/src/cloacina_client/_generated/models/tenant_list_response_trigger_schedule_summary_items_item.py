...
T = TypeVar("T", bound="TenantListResponseTriggerScheduleSummaryItemsItem")


@_attrs_define
class TenantListResponseTriggerScheduleSummaryItemsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tenant_list_response_trigger_schedule_summary_items_item = cls(
            created_at=created_at,
            enabled=enabled,
            id=id,
            schedule_type=schedule_type,
        ...
        tenant_list_response_trigger_schedule_summary_items_item.additional_properties = d
        return tenant_list_response_trigger_schedule_summary_items_item
