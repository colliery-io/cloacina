...
T = TypeVar("T", bound="TenantListResponseWorkflowInstanceSummaryItemsItem")


@_attrs_define
class TenantListResponseWorkflowInstanceSummaryItemsItem:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        tenant_list_response_workflow_instance_summary_items_item = cls(
            created_at=created_at,
            enabled=enabled,
            id=id,
            instance_name=instance_name,
        ...
        tenant_list_response_workflow_instance_summary_items_item.additional_properties = d
        return tenant_list_response_workflow_instance_summary_items_item
