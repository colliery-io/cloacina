...
T = TypeVar("T", bound="ListResponseReactorStatusItemsItem")


@_attrs_define
class ListResponseReactorStatusItemsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_response_reactor_status_items_item = cls(
            accumulators=accumulators,
            health=health,
            name=name,
            paused=paused,
        ...
        list_response_reactor_status_items_item.additional_properties = d
        return list_response_reactor_status_items_item
