...
- [Tutorial 10 - Task Deferral]({{< ref "/tutorials/10-task-deferral" >}}) -- step-by-step walkthrough with the deferred-tasks example
- [Macro Reference]({{< ref "/reference/macros" >}}) -- `#[task]` attribute reference including handle detection
- [Task Execution Sequence]({{< ref "/explanation/task-execution-sequence" >}}) -- how a task moves from scheduling through execution
- [Dispatcher Architecture]({{< ref "/explanation/dispatcher-architecture" >}}) -- how the executor receives and processes task events
