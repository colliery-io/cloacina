# cloacina::packaging::debug <span class="plissken-badge plissken-badge-source" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: #ff5722; color: white;">Rust</span>
...
### `cloacina::packaging::debug::TaskDebugInfo`
...
### `cloacina::packaging::debug::DebugResult` <span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: #4caf50; color: white;">pub</span>
...
### `cloacina::packaging::debug::extract_manifest_from_package`

<span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: #4caf50; color: white;">pub</span>


```rust
fn extract_manifest_from_package (package_path : & PathBuf) -> Result < Manifest >
```
...
### `cloacina::packaging::debug::execute_task_from_library`

<span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: #4caf50; color: white;">pub</span>


```rust
fn execute_task_from_library (library_path : & PathBuf , task_name : & str , context_json : & str ,) -> Result < String >
```
...
### `cloacina::packaging::debug::resolve_task_name`

<span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: #4caf50; color: white;">pub</span>


```rust
fn resolve_task_name (manifest : & Manifest , task_identifier : & str) -> Result < String >
```
...
### `cloacina::packaging::debug::debug_package`

<span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: #4caf50; color: white;">pub</span>


```rust
fn debug_package (package_path : & PathBuf , task_identifier : Option < & str > , context_json : Option < & str > ,) -> Result < DebugResult >
```
