# cloacina::registry::loader::constructor_loader <span class="plissken-badge plissken-badge-source" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: #ff5722; color: white;">Rust</span>
...
### `cloacina::registry::loader::constructor_loader::ProviderConfigure`
...
### `cloacina::registry::loader::constructor_loader::WasmTaskConstructor`
...
### `cloacina::registry::loader::constructor_loader::TriggerBinding`
...
| Name | Type | Description |
|------|------|-------------|
| `poll_interval` | `Duration` | How often the reconciler polls this trigger (ignored for cron triggers). |
| `allow_concurrent` | `bool` | Whether concurrent fires with the same context hash are allowed. |
| `workflow_name` | `String` | The workflow this trigger fires (the `#[trigger(on = "...")]` binding). |
| `cron_expression` | `Option < String >` | Optional cron expression; `Some` routes to the cron scheduler instead of
the poll-interval trigger registry. |



### `cloacina::registry::loader::constructor_loader::WasmTriggerConstructor`
...
### `cloacina::registry::loader::constructor_loader::WasmAccumulatorConstructor`
...
### `cloacina::registry::loader::constructor_loader::ProviderStreamSource`

<span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: #4caf50; color: white;">pub</span>


An [`EventSource`] that drains a native provider's server-streaming `source` (a [`ChunkStream`](fidius_host::ChunkStream) from [`PluginHandle::call_streaming`](fidius_host::PluginHandle::call_streaming)) and pushes each boundary-JSON item onto the accumulator merge channel.
...
### `cloacina::registry::loader::constructor_loader::WasmReactorConstructor`
...
##### `evaluate` <span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: #4caf50; color: white;">pub</span>
...
### `cloacina::registry::loader::constructor_loader::ConstructorNode`
...
### `cloacina::registry::loader::constructor_loader::OrderedConfig`
...
| Name | Type | Description |
|------|------|-------------|
| `0` | `Vec < TypedConfigValue >` |  |



## Enums

### `cloacina::registry::loader::constructor_loader::ConstructorBinding` <span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: #4caf50; color: white;">pub</span>
...
- **`Task`** - Register the loaded constructor as a [`Task`] under this namespace.
- **`Trigger`** - Register the loaded constructor as a [`Trigger`] with this scheduling
metadata. The trigger is keyed in the registry by the manifest `name`.



### `cloacina::registry::loader::constructor_loader::TypedConfigValue` <span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: var(--md-default-fg-color--light); color: white;">private</span>
...
### `cloacina::registry::loader::constructor_loader::read_provider_manifest`
...
### `cloacina::registry::loader::constructor_loader::read_member_manifest`
...
### `cloacina::registry::loader::constructor_loader::wrap_member_config`
...
### `cloacina::registry::loader::constructor_loader::resolve_native_provider`
...
### `cloacina::registry::loader::constructor_loader::load_native_member`
...
Load a configured member from a NATIVE provider cdylib. Returns `Ok(None)` when `package_name` is not a native provider in `search_path` (caller then takes the WASM path). On the native path it `dlopen`s the provider cdylib, selects the per-kind holder plugin (`__Provider{Task,Trigger,Accumulator,Reactor}`), and binds the member's config once via `configure_from_loaded`. NO grants/egress are applied (native = trusted, I-0139 (e)).
...
### `cloacina::registry::loader::constructor_loader::exec_err`
...
### `cloacina::registry::loader::constructor_loader::read_constructor_manifest`
...
### `cloacina::registry::loader::constructor_loader::load_task_constructor`
...
### `cloacina::registry::loader::constructor_loader::unpack_provider_archive`
...
### `cloacina::registry::loader::constructor_loader::load_task_constructor_from_package`
...
### `cloacina::registry::loader::constructor_loader::load_trigger_constructor`
...
### `cloacina::registry::loader::constructor_loader::load_constructor`
...
### `cloacina::registry::loader::constructor_loader::load_accumulator_constructor`
...
### `cloacina::registry::loader::constructor_loader::load_stream_accumulator_source`
...
### `cloacina::registry::loader::constructor_loader::load_stream_accumulator_source_from_config`
...
### `cloacina::registry::loader::constructor_loader::load_reactor_constructor`
...
### `cloacina::registry::loader::constructor_loader::set_provider_search_path`
...
### `cloacina::registry::loader::constructor_loader::clear_provider_search_path`
...
### `cloacina::registry::loader::constructor_loader::provider_search_path`
...
### `cloacina::registry::loader::constructor_loader::provider_package_name`
...
### `cloacina::registry::loader::constructor_loader::provider_version_pin`
...
### `cloacina::registry::loader::constructor_loader::version_satisfies_pin`
...
### `cloacina::registry::loader::constructor_loader::enforce_version_pin`
...
### `cloacina::registry::loader::constructor_loader::coerce_config_value`
...
### `cloacina::registry::loader::constructor_loader::int_in_range`
...
### `cloacina::registry::loader::constructor_loader::uint_in_range`
...
### `cloacina::registry::loader::constructor_loader::bind_config_by_name`
...
### `cloacina::registry::loader::constructor_loader::lint_constructor_grants`
...
### `cloacina::registry::loader::constructor_loader::load_constructor_node`
...
### `cloacina::registry::loader::constructor_loader::load_reactor_constructor_node`
