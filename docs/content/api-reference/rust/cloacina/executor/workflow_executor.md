# cloacina::executor::workflow_executor <span class="plissken-badge plissken-badge-source" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: #ff5722; color: white;">Rust</span>
...
### `cloacina::executor::workflow_executor::TaskResult`
...
### `cloacina::executor::workflow_executor::WorkflowExecutionResult`
...
### `cloacina::executor::workflow_executor::WorkflowExecution`
...
### `cloacina::executor::workflow_executor::WorkflowExecutionError` <span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: #4caf50; color: white;">pub</span>
...
### `cloacina::executor::workflow_executor::WorkflowStatus` <span class="plissken-badge plissken-badge-visibility" style="display: inline-block; padding: 0.1em 0.35em; font-size: 0.55em; font-weight: 600; border-radius: 0.2em; vertical-align: middle; background: #4caf50; color: white;">pub</span>
