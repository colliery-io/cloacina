...
| A workflow that fires on a custom poll / event / file watch | Implement the [Trigger trait]({{< ref "/workflows/tutorials/service/09-event-triggers" >}}) — no reactor involved |
