...
- Completion of [Tutorial 3]({{< ref "/workflows/tutorials/library/03-complex-workflows/" >}})
...
angreal demos tutorials rust 04
```
...
- [Macro Reference]({{< ref "/reference/macros" >}}) - Complete reference for all retry options, trigger rule forms, callback signatures, and backoff strategies
...
You can download the complete example code from our [GitHub repository](https://github.com/colliery-io/cloacina/tree/main/examples/tutorials/workflows/library/04-error-handling).
