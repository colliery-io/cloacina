...
- Completion of [Tutorial 09 — Full Reactive Pipeline]({{< ref "/tutorials/computation-graphs/library/09-full-pipeline/" >}})
...
- [Python Tutorial 09 — Your First Computation Graph]({{< ref "/tutorials/computation-graphs/python/09-computation-graph/" >}}): the same concepts in Python using `ComputationGraphBuilder` and `@cloaca.node`
- [Python Tutorial 11 — Routing]({{< ref "/tutorials/computation-graphs/python/11-routing/" >}}): tuple-based routing in Python
