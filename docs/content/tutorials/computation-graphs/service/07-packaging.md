...
- Completion of the library tutorial [07 - Your First Computation Graph]({{< ref "/tutorials/computation-graphs/library/07-computation-graph/" >}})
...
- [**Tutorial 08: WebSocket Event Injection**]({{< ref "/tutorials/computation-graphs/service/08-websocket-events/" >}}) — push events to the `orderbook` accumulator over a WebSocket connection
- [**Tutorial 09: Kafka-Sourced Computation Graphs**]({{< ref "/tutorials/computation-graphs/service/09-kafka-stream/" >}}) — drive accumulators from a Kafka topic instead of WebSocket
