...
1. [Tutorial 07]({{< ref "/tutorials/computation-graphs/service/07-packaging/" >}}) — packaging and uploading a computation graph
2. [Tutorial 08]({{< ref "/tutorials/computation-graphs/service/08-websocket-events/" >}}) — pushing events via WebSocket
