...
Welcome to the second tutorial in our Cloacina series! In this tutorial, you'll learn how to use Context for data flow between tasks in your workflows. Context is the foundation of data passing in Cloacina, allowing tasks to share information and build complex data processing pipelines. We'll build on the concepts from [Tutorial 1]({{< ref "/tutorials/workflows/library/01-first-workflow/" >}}) and show you how to connect multiple tasks through shared context.

## Prerequisites

- Completion of [Tutorial 1]({{< ref "/tutorials/workflows/library/01-first-workflow/" >}})
