...
- Have completed [Tutorial 1 - First Workflow]({{< ref "/tutorials/workflows/library/01-first-workflow/" >}})
...
- [Task Deferral Architecture]({{< ref "/explanation/workflows/task-deferral" >}}) -- internal mechanics of slot tokens and the defer_until lifecycle
