...
- [**Tutorial 08: Working with the Workflow Registry**]({{< ref "/tutorials/workflows/service/08-workflow-registry/" >}}) - Register and execute workflows dynamically
...
- [Tutorial 08: Working with the Workflow Registry]({{< ref "/tutorials/workflows/service/08-workflow-registry/" >}})
- [Explanation: Packaged Workflow Architecture]({{< ref "/explanation/platform/packaged-workflow-architecture/" >}})
