...
Top-level errors for workflow execution.

**Defined in:** `cloacina::executor::WorkflowExecutionError`
...
| `ValidationError` | `WorkflowExecutionError::Validation` |
| `TaskError` | `WorkflowExecutionError::TaskExecution` |
| `ExecutorError` | `WorkflowExecutionError::Executor` |
...
- [Cron Scheduling Architecture]({{< ref "/engine/explanation/cron-scheduling" >}}) -- recovery behavior for cron errors
