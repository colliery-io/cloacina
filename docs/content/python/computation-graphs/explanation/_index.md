...
- [Python · Workflows · Explanation · Python Runtime Architecture]({{< ref "/embed/explanation/python-runtime-architecture" >}}) — the PyO3 / GIL / FFI layer all Python surfaces share.
