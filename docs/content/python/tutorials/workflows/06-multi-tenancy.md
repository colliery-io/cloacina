...
- Completion of [Tutorial 5]({{< ref "/python/tutorials/workflows/05-cron-scheduling/" >}})
...
{{< button relref="/python/tutorials/workflows/07-event-triggers/" >}}Tutorial 07: Event Triggers{{< /button >}}

Or explore these resources:

{{< button relref="/python/how-to-guides/" >}}Explore How-to Guides{{< /button >}}
{{< button relref="/python/api-reference/" >}}Browse API Reference{{< /button >}}

### Recommended Learning Path

1. **[Tutorial 07: Event Triggers]({{< ref "/python/tutorials/workflows/07-event-triggers/" >}})** - Event-driven workflow execution
2. **[How-to: Backend Selection]({{< ref "/python/how-to-guides/backend-selection/" >}})** - Choose between SQLite and PostgreSQL
3. **[How-to: Performance Optimization]({{< ref "/python/how-to-guides/performance-optimization/" >}})** - Scale your workflows
