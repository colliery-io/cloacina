...
- Completion of [Tutorial 1]({{< ref "/python/tutorials/workflows/01-first-python-workflow/" >}})
...
{{< button relref="/python/tutorials/workflows/03-complex-workflows/" >}}Continue to Tutorial 03{{< /button >}}

## Related Resources

- [API Reference: Context]({{< ref "/python/api-reference/context/" >}}) - Complete Context API
- [Examples: Data Processing]({{< ref "/python/examples/basic-workflow/" >}}) - More data pipeline examples
- [How-to: Testing Workflows]({{< ref "/python/how-to-guides/testing-workflows/" >}}) - Testing with context data
