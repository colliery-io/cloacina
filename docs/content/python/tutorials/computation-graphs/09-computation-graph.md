...
- [Tutorial 10 — Accumulators]({{< ref "/python/tutorials/computation-graphs/10-accumulators/" >}}): use `@cloaca.passthrough_accumulator` to transform raw events before they reach the graph
