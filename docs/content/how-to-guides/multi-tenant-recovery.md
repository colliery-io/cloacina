...
See the [multi-tenant example](https://github.com/colliery-io/cloacina/tree/main/examples/tutorials/06-multi-tenancy) for a working demonstration of these concepts.
